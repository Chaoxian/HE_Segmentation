...
## Load dataset
train_dataset = SegmentationDataset_2cls(data_dir=data_dir, transform=transform_val,train="train")
val_dataset = SegmentationDataset_2cls(data_dir=data_dir, transform=transform_val,train="val")
